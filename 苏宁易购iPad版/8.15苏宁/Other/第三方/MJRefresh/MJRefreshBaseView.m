...
//    UIImageView *bgImage=[[UIImageView alloc]initWithFrame:CGRectMake(260, 0, 260, 110)];
//    [self addSubview:bgImage];
//    NSMutableArray *refreshingImages = [NSMutableArray array];
//    for (NSUInteger k = 1; k<=3; k++) {
//        for (NSInteger i=1; i<=161; i++) {
//            UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"roration%d.png", i]];
//            [refreshingImages addObject:image];
//        }
//    }
//    [bgImage setAnimationImages:refreshingImages];
//    [bgImage setAnimationDuration:4];
//    [bgImage setAnimationRepeatCount:1];
